...
object PillagerCampaignsConfig {
    ...
    init {
        ...
        enabled = builder.comment("Enable pack-owned pillager campaign patrols.").define("enabled", true)
        ...
        allowCreativePlayers = builder.comment("Keep true while tuning so creative playtests still receive campaigns.").define("allow_creative_players", true)
        skipSpectatorPlayers = builder.define("skip_spectator_players", true)
        disableVanillaPatrolSpawning = builder.comment("Set doPatrolSpawning=false on server start so this mod owns patrol and campaign scheduling.").define("disable_vanilla_patrol_spawning", true)
        builder.pop()
