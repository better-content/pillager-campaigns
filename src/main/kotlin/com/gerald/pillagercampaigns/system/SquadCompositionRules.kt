...
object SquadCompositionRules {
    ...
    const val INFANTRY = "pillager_campaigns:infantry"
    const val ENGINEER = "pillager_campaigns:engineer"
    const val BANNER_GUARD = "pillager_campaigns:banner_guard"
...
data class SquadCompositionPressure(
    ...
    companion object {
        ...
        fun fromGenes(genes: com.gerald.pillagercampaigns.data.OfficerGeneProfile): SquadCompositionPressure =
