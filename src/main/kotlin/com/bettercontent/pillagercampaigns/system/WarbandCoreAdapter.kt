...
import com.bettercontent.pillagercampaigns.data.CampaignRouteStep
...
import com.bettercontent.pillagercampaigns.data.OfficerState as LiveOfficerState
import com.bettercontent.pillagercampaigns.data.PlannedCampaignMember
import com.bettercontent.pillagercampaigns.data.PresenceMaterializationResult
import com.bettercontent.pillagercampaigns.data.RallyPresenceRecord
...
object WarbandCoreAdapter {
    ...
    private val recruitTag = TagKey.create(Registries.ENTITY_TYPE, ResourceLocation("pillager_campaigns", "recruits"))
