...
import com.bettercontent.pillagercampaigns.gametest.OpeningProgressionRuntimeValidation
import com.bettercontent.pillagercampaigns.system.CampaignMath
import com.bettercontent.pillagercampaigns.system.PillagerCampaignCoordinator
import com.bettercontent.pillagercampaigns.system.WarbandCoreAdapter
import com.bettercontent.pillagercampaigns.system.PillagerDiscoveryCoordinator
import com.bettercontent.pillagercampaigns.system.PillagerRuntime
import com.bettercontent.pillagercampaigns.system.PillagerWarbandPresenceSystem
...
object PillagerCampaignsEvents {
    ...
    fun onEntityLeaveLevel(event: EntityLeaveLevelEvent) {
        ...
        if (tag.getBoolean(PillagerRuntime.BOSS_TAG) && tag.hasUUID(PillagerRuntime.OFFICER_TAG)) {
            ...
            if (warband != null) {
                ...
                warband.rallyPresence?.state = com.bettercontent.pillagercampaigns.data.RallyPresenceState.DORMANT
    ...
    private fun register(dispatcher: CommandDispatcher<CommandSourceStack>) {
        dispatcher.register(
            LiteralArgumentBuilder.literal<CommandSourceStack>("pillager_campaigns")
    ...
    internal fun formatWarbandLine(warband: com.bettercontent.pillagercampaigns.data.PillagerWarband): String {
    ...
    fun onAddReloadListeners(event: AddReloadListenerEvent) {
        event.addListener(com.bettercontent.pillagercampaigns.system.WarbandFormulaData)
    }
